<template>
    <div>
        <div class="app-container">
            <div class="mt20">
                <el-form :inline="true" size="mini">
                    ...
                    <el-form-item>
                        <br>
                        <el-button type="primary" class="el-button-search" @click="generateGraph()">点击生成</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        ...
        <el-drawer
                ...
                :with-header="false"
        >
            <iframe src="/relation-graph-codes/Demo4Logo.html" width="100%" height="100%" frameborder="0"
    ...
    export default {
        ...
        methods: {
            showSeeksGraph(query) {
                let self = this;
                self.$http.get(self.api.getGraphDemo, {},
                    function (response) {
                        if (response.code == 0) {
                            ...
                            //   var __graph_json_data = {"rootId":"test","nodes":[{"id":"a","text":"a"},{"id":"b","text":"b"}],"links":[{"from":"a","to":"b","text":"xxx"}]};
            ...
            generateGraph(){
                let self = this;
                self.$http.post(self.api.getGraphFromData, self.model.textarea, {
                    headers: {
